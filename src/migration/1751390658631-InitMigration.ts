...
export class InitMigration1751390658631 implements MigrationInterface {
    name = 'InitMigration1751390658631'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."businesses_contact_preference_enum" AS ENUM('Phone', 'Email')`);
