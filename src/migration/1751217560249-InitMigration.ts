...
export class InitMigration1751217560249 implements MigrationInterface {
    name = 'InitMigration1751217560249'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "business_pet_mapping" ("map_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "note" text, "title" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "business_id" uuid NOT NULL, "pet_id" uuid NOT NULL, "staff_id" uuid, CONSTRAINT "PK_cd1ff54160ad08f9034f9f76157" PRIMARY KEY ("map_id"))`);
